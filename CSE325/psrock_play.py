...
import psrock
import importlib
#importlib.reload(psrock) - get rid of importlib for Python2
reload(psrock)

import team1, team2, team3, team4, team5, team6, team7, team8, team9  # These are file names in this folder     
...
#importlib.reload(team5) - get rid of importlib for Python2
reload(team1) 
reload(team2)
reload(team3)
reload(team4)
...
short_report, long_report = psrock.round_robin(30, team1, team2, team3, team4, team5, team6, team7, team8, team9)        
